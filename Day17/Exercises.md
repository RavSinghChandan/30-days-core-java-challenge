...
Exercise 1: [Exercise description related to map – hashmap, treemap, linkedhashmap] Exercise 2: [Exercise description related to map – hashmap, treemap, linkedhashmap] Exercise 3: [Exercise description related to map – hashmap, treemap, linkedhashmap] Exercise 4: [Exercise description related to map – hashmap, treemap, linkedhashmap] Exercise 5: [Exercise description related to map – hashmap, treemap, linkedhashmap]  */
...
public class Exercises {
    ...
    public static void main(String[] args) {         System.out.println("Day 17 Exercises: Map – HashMap, TreeMap, LinkedHashMap\n");
