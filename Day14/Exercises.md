...
Exercise 1: [Exercise description related to custom exceptions + mini project: bank system] Exercise 2: [Exercise description related to custom exceptions + mini project: bank system] Exercise 3: [Exercise description related to custom exceptions + mini project: bank system] Exercise 4: [Exercise description related to custom exceptions + mini project: bank system] Exercise 5: [Exercise description related to custom exceptions + mini project: bank system]  */
...
public class Exercises {
    ...
    public static void main(String[] args) {         System.out.println("Day 14 Exercises: Custom Exceptions + Mini Project: Bank System\n");
