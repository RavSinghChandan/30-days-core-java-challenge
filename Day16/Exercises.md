...
Exercise 1: [Exercise description related to set – hashset, linkedhashset, treeset] Exercise 2: [Exercise description related to set – hashset, linkedhashset, treeset] Exercise 3: [Exercise description related to set – hashset, linkedhashset, treeset] Exercise 4: [Exercise description related to set – hashset, linkedhashset, treeset] Exercise 5: [Exercise description related to set – hashset, linkedhashset, treeset]  */
...
public class Exercises {
    ...
    public static void main(String[] args) {         System.out.println("Day 16 Exercises: Set – HashSet, LinkedHashSet, TreeSet\n");
