...
Exercise 1: [Exercise description related to java 8: stream api basics] Exercise 2: [Exercise description related to java 8: stream api basics] Exercise 3: [Exercise description related to java 8: stream api basics] Exercise 4: [Exercise description related to java 8: stream api basics] Exercise 5: [Exercise description related to java 8: stream api basics]  */
...
public class Exercises {
    ...
    public static void main(String[] args) {         System.out.println("Day 21 Exercises: Java 8: Stream API Basics\n");
