...
Exercise 1: [Exercise description related to collections – list, arraylist, linkedlist, vector] Exercise 2: [Exercise description related to collections – list, arraylist, linkedlist, vector] Exercise 3: [Exercise description related to collections – list, arraylist, linkedlist, vector] Exercise 4: [Exercise description related to collections – list, arraylist, linkedlist, vector] Exercise 5: [Exercise description related to collections – list, arraylist, linkedlist, vector]  */
...
public class Exercises {
    ...
    public static void main(String[] args) {         System.out.println("Day 15 Exercises: Collections – List, ArrayList, LinkedList, Vector\n");
