...
Exercise 1: [Exercise description related to multithreading basics] Exercise 2: [Exercise description related to multithreading basics] Exercise 3: [Exercise description related to multithreading basics] Exercise 4: [Exercise description related to multithreading basics] Exercise 5: [Exercise description related to multithreading basics]  */
...
public class Exercises {
    ...
    public static void main(String[] args) {         System.out.println("Day 25 Exercises: Multithreading Basics\n");
