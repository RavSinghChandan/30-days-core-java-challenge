...
Exercise 1: [Exercise description related to comparable vs comparator] Exercise 2: [Exercise description related to comparable vs comparator] Exercise 3: [Exercise description related to comparable vs comparator] Exercise 4: [Exercise description related to comparable vs comparator] Exercise 5: [Exercise description related to comparable vs comparator]  */
...
public class Exercises {
    ...
    public static void main(String[] args) {         System.out.println("Day 19 Exercises: Comparable vs Comparator\n");
