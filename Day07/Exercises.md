...
Exercise 1: [Exercise description related to access modifiers, final keyword, static blocks] Exercise 2: [Exercise description related to access modifiers, final keyword, static blocks] Exercise 3: [Exercise description related to access modifiers, final keyword, static blocks] Exercise 4: [Exercise description related to access modifiers, final keyword, static blocks] Exercise 5: [Exercise description related to access modifiers, final keyword, static blocks]  */
...
public class Exercises {
    ...
    public static void main(String[] args) {         System.out.println("Day 07 Exercises: Access Modifiers, final keyword, static blocks\n");
