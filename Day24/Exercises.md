...
Exercise 1: [Exercise description related to file handling] Exercise 2: [Exercise description related to file handling] Exercise 3: [Exercise description related to file handling] Exercise 4: [Exercise description related to file handling] Exercise 5: [Exercise description related to file handling]  */
...
public class Exercises {
    ...
    public static void main(String[] args) {         System.out.println("Day 24 Exercises: File Handling\n");
