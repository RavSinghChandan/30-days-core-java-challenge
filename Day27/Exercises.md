...
Exercise 1: [Exercise description related to design patterns] Exercise 2: [Exercise description related to design patterns] Exercise 3: [Exercise description related to design patterns] Exercise 4: [Exercise description related to design patterns] Exercise 5: [Exercise description related to design patterns]  */
...
public class Exercises {
    ...
    public static void main(String[] args) {         System.out.println("Day 27 Exercises: Design Patterns\n");
