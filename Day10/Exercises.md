...
Exercise 1: [Exercise description related to abstraction – abstract class vs interface] Exercise 2: [Exercise description related to abstraction – abstract class vs interface] Exercise 3: [Exercise description related to abstraction – abstract class vs interface] Exercise 4: [Exercise description related to abstraction – abstract class vs interface] Exercise 5: [Exercise description related to abstraction – abstract class vs interface]  */
...
public class Exercises {
    ...
    public static void main(String[] args) {         System.out.println("Day 10 Exercises: Abstraction – Abstract Class vs Interface\n");
