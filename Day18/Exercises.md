...
Exercise 1: [Exercise description related to queue, stack, deque] Exercise 2: [Exercise description related to queue, stack, deque] Exercise 3: [Exercise description related to queue, stack, deque] Exercise 4: [Exercise description related to queue, stack, deque] Exercise 5: [Exercise description related to queue, stack, deque]  */
...
public class Exercises {
    ...
    public static void main(String[] args) {         System.out.println("Day 18 Exercises: Queue, Stack, Deque\n");
