...
Exercise 1: [Exercise description related to java 8: lambda expressions, functional interfaces] Exercise 2: [Exercise description related to java 8: lambda expressions, functional interfaces] Exercise 3: [Exercise description related to java 8: lambda expressions, functional interfaces] Exercise 4: [Exercise description related to java 8: lambda expressions, functional interfaces] Exercise 5: [Exercise description related to java 8: lambda expressions, functional interfaces]  */
...
public class Exercises {
    ...
    public static void main(String[] args) {         System.out.println("Day 20 Exercises: Java 8: Lambda Expressions, Functional Interfaces\n");
